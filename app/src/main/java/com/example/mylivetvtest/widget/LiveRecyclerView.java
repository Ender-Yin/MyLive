 ...
 * @Author：wuhaoteng
 * @Date:2018/12/23
 * @Desc：支持 1.选中项居中 2.焦点记忆 3.可以控制是否横竖向移除 此刻是不能纵向移出
 */
public class LiveRecyclerView extends RecyclerView {
    ...
    public LiveRecyclerView(Context context,  AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LiveRecyclerView(Context context,  AttributeSet attrs, int defStyle) {
